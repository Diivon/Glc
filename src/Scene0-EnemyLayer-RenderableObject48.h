...
class Scene0;
class EnemyLayer;
class RenderableObject48 : public ::gc::TypeAliases<RenderableObject48>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject48 this_t;
	RenderableObject48 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject48(Scene0 &, EnemyLayer &);
	~RenderableObject48();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject48(const RenderableObject48 &) = delete;
			RenderableObject48(RenderableObject48 &&) = delete;
			void operator = (const RenderableObject48 &) = delete;
			void operator = (RenderableObject48 &&) = delete;
		};
