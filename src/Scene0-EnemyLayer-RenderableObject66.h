...
class Scene0;
class EnemyLayer;
class RenderableObject66 : public ::gc::TypeAliases<RenderableObject66>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject66 this_t;
	RenderableObject66 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject66(Scene0 &, EnemyLayer &);
	~RenderableObject66();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject66(const RenderableObject66 &) = delete;
			RenderableObject66(RenderableObject66 &&) = delete;
			void operator = (const RenderableObject66 &) = delete;
			void operator = (RenderableObject66 &&) = delete;
		};
