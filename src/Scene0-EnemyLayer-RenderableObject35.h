...
class Scene0;
class EnemyLayer;
class RenderableObject35 : public ::gc::TypeAliases<RenderableObject35>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject35 this_t;
	RenderableObject35 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject35(Scene0 &, EnemyLayer &);
	~RenderableObject35();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject35(const RenderableObject35 &) = delete;
			RenderableObject35(RenderableObject35 &&) = delete;
			void operator = (const RenderableObject35 &) = delete;
			void operator = (RenderableObject35 &&) = delete;
		};
