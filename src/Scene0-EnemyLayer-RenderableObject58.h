...
class Scene0;
class EnemyLayer;
class RenderableObject58 : public ::gc::TypeAliases<RenderableObject58>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject58 this_t;
	RenderableObject58 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject58(Scene0 &, EnemyLayer &);
	~RenderableObject58();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject58(const RenderableObject58 &) = delete;
			RenderableObject58(RenderableObject58 &&) = delete;
			void operator = (const RenderableObject58 &) = delete;
			void operator = (RenderableObject58 &&) = delete;
		};
