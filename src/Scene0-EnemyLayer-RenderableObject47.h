...
class Scene0;
class EnemyLayer;
class RenderableObject47 : public ::gc::TypeAliases<RenderableObject47>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject47 this_t;
	RenderableObject47 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject47(Scene0 &, EnemyLayer &);
	~RenderableObject47();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject47(const RenderableObject47 &) = delete;
			RenderableObject47(RenderableObject47 &&) = delete;
			void operator = (const RenderableObject47 &) = delete;
			void operator = (RenderableObject47 &&) = delete;
		};
