...
class Scene0;
class EnemyLayer;
class RenderableObject46 : public ::gc::TypeAliases<RenderableObject46>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject46 this_t;
	RenderableObject46 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject46(Scene0 &, EnemyLayer &);
	~RenderableObject46();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject46(const RenderableObject46 &) = delete;
			RenderableObject46(RenderableObject46 &&) = delete;
			void operator = (const RenderableObject46 &) = delete;
			void operator = (RenderableObject46 &&) = delete;
		};
