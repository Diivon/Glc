...
class Scene0;
class EnemyLayer;
class RenderableObject22 : public ::gc::TypeAliases<RenderableObject22>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject22 this_t;
	RenderableObject22 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject22(Scene0 &, EnemyLayer &);
	~RenderableObject22();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject22(const RenderableObject22 &) = delete;
			RenderableObject22(RenderableObject22 &&) = delete;
			void operator = (const RenderableObject22 &) = delete;
			void operator = (RenderableObject22 &&) = delete;
		};
