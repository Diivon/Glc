...
class Scene0;
class EnemyLayer;
class RenderableObject59 : public ::gc::TypeAliases<RenderableObject59>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject59 this_t;
	RenderableObject59 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject59(Scene0 &, EnemyLayer &);
	~RenderableObject59();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject59(const RenderableObject59 &) = delete;
			RenderableObject59(RenderableObject59 &&) = delete;
			void operator = (const RenderableObject59 &) = delete;
			void operator = (RenderableObject59 &&) = delete;
		};
