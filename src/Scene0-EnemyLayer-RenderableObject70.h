...
class Scene0;
class EnemyLayer;
class RenderableObject70 : public ::gc::TypeAliases<RenderableObject70>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject70 this_t;
	RenderableObject70 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject70(Scene0 &, EnemyLayer &);
	~RenderableObject70();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject70(const RenderableObject70 &) = delete;
			RenderableObject70(RenderableObject70 &&) = delete;
			void operator = (const RenderableObject70 &) = delete;
			void operator = (RenderableObject70 &&) = delete;
		};
