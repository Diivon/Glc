...
class Scene0;
class EnemyLayer;
class RenderableObject68 : public ::gc::TypeAliases<RenderableObject68>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject68 this_t;
	RenderableObject68 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject68(Scene0 &, EnemyLayer &);
	~RenderableObject68();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject68(const RenderableObject68 &) = delete;
			RenderableObject68(RenderableObject68 &&) = delete;
			void operator = (const RenderableObject68 &) = delete;
			void operator = (RenderableObject68 &&) = delete;
		};
