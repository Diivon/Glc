...
class Scene0;
class EnemyLayer;
class RenderableObject56 : public ::gc::TypeAliases<RenderableObject56>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject56 this_t;
	RenderableObject56 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject56(Scene0 &, EnemyLayer &);
	~RenderableObject56();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject56(const RenderableObject56 &) = delete;
			RenderableObject56(RenderableObject56 &&) = delete;
			void operator = (const RenderableObject56 &) = delete;
			void operator = (RenderableObject56 &&) = delete;
		};
