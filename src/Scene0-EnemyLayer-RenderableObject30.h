...
class Scene0;
class EnemyLayer;
class RenderableObject30 : public ::gc::TypeAliases<RenderableObject30>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject30 this_t;
	RenderableObject30 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject30(Scene0 &, EnemyLayer &);
	~RenderableObject30();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject30(const RenderableObject30 &) = delete;
			RenderableObject30(RenderableObject30 &&) = delete;
			void operator = (const RenderableObject30 &) = delete;
			void operator = (RenderableObject30 &&) = delete;
		};
