...
class Scene0;
class EnemyLayer;
class RenderableObject69 : public ::gc::TypeAliases<RenderableObject69>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject69 this_t;
	RenderableObject69 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject69(Scene0 &, EnemyLayer &);
	~RenderableObject69();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject69(const RenderableObject69 &) = delete;
			RenderableObject69(RenderableObject69 &&) = delete;
			void operator = (const RenderableObject69 &) = delete;
			void operator = (RenderableObject69 &&) = delete;
		};
