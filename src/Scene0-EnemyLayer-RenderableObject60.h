...
class Scene0;
class EnemyLayer;
class RenderableObject60 : public ::gc::TypeAliases<RenderableObject60>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject60 this_t;
	RenderableObject60 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject60(Scene0 &, EnemyLayer &);
	~RenderableObject60();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject60(const RenderableObject60 &) = delete;
			RenderableObject60(RenderableObject60 &&) = delete;
			void operator = (const RenderableObject60 &) = delete;
			void operator = (RenderableObject60 &&) = delete;
		};
