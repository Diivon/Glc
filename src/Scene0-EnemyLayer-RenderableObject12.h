...
class Scene0;
class EnemyLayer;
class RenderableObject12 : public ::gc::TypeAliases<RenderableObject12>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject12 this_t;
	RenderableObject12 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject12(Scene0 &, EnemyLayer &);
	~RenderableObject12();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject12(const RenderableObject12 &) = delete;
			RenderableObject12(RenderableObject12 &&) = delete;
			void operator = (const RenderableObject12 &) = delete;
			void operator = (RenderableObject12 &&) = delete;
		};
