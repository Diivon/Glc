...
class Scene0;
class EnemyLayer;
class RenderableObject24 : public ::gc::TypeAliases<RenderableObject24>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject24 this_t;
	RenderableObject24 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject24(Scene0 &, EnemyLayer &);
	~RenderableObject24();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject24(const RenderableObject24 &) = delete;
			RenderableObject24(RenderableObject24 &&) = delete;
			void operator = (const RenderableObject24 &) = delete;
			void operator = (RenderableObject24 &&) = delete;
		};
