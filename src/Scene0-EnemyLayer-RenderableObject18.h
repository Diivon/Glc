...
class Scene0;
class EnemyLayer;
class RenderableObject18 : public ::gc::TypeAliases<RenderableObject18>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject18 this_t;
	RenderableObject18 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject18(Scene0 &, EnemyLayer &);
	~RenderableObject18();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject18(const RenderableObject18 &) = delete;
			RenderableObject18(RenderableObject18 &&) = delete;
			void operator = (const RenderableObject18 &) = delete;
			void operator = (RenderableObject18 &&) = delete;
		};
