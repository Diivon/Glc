...
class Scene0;
class EnemyLayer;
class RenderableObject53 : public ::gc::TypeAliases<RenderableObject53>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject53 this_t;
	RenderableObject53 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject53(Scene0 &, EnemyLayer &);
	~RenderableObject53();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject53(const RenderableObject53 &) = delete;
			RenderableObject53(RenderableObject53 &&) = delete;
			void operator = (const RenderableObject53 &) = delete;
			void operator = (RenderableObject53 &&) = delete;
		};
