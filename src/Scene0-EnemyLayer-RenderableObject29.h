...
class Scene0;
class EnemyLayer;
class RenderableObject29 : public ::gc::TypeAliases<RenderableObject29>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject29 this_t;
	RenderableObject29 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject29(Scene0 &, EnemyLayer &);
	~RenderableObject29();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject29(const RenderableObject29 &) = delete;
			RenderableObject29(RenderableObject29 &&) = delete;
			void operator = (const RenderableObject29 &) = delete;
			void operator = (RenderableObject29 &&) = delete;
		};
