...
class Scene0;
class EnemyLayer;
class RenderableObject55 : public ::gc::TypeAliases<RenderableObject55>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject55 this_t;
	RenderableObject55 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject55(Scene0 &, EnemyLayer &);
	~RenderableObject55();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject55(const RenderableObject55 &) = delete;
			RenderableObject55(RenderableObject55 &&) = delete;
			void operator = (const RenderableObject55 &) = delete;
			void operator = (RenderableObject55 &&) = delete;
		};
