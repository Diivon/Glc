...
class Scene0;
class EnemyLayer;
class RenderableObject39 : public ::gc::TypeAliases<RenderableObject39>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject39 this_t;
	RenderableObject39 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject39(Scene0 &, EnemyLayer &);
	~RenderableObject39();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject39(const RenderableObject39 &) = delete;
			RenderableObject39(RenderableObject39 &&) = delete;
			void operator = (const RenderableObject39 &) = delete;
			void operator = (RenderableObject39 &&) = delete;
		};
