...
class Scene0;
class EnemyLayer;
class RenderableObject45 : public ::gc::TypeAliases<RenderableObject45>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject45 this_t;
	RenderableObject45 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject45(Scene0 &, EnemyLayer &);
	~RenderableObject45();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject45(const RenderableObject45 &) = delete;
			RenderableObject45(RenderableObject45 &&) = delete;
			void operator = (const RenderableObject45 &) = delete;
			void operator = (RenderableObject45 &&) = delete;
		};
