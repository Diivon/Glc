...
class Scene0;
class EnemyLayer;
class RenderableObject19 : public ::gc::TypeAliases<RenderableObject19>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject19 this_t;
	RenderableObject19 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject19(Scene0 &, EnemyLayer &);
	~RenderableObject19();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject19(const RenderableObject19 &) = delete;
			RenderableObject19(RenderableObject19 &&) = delete;
			void operator = (const RenderableObject19 &) = delete;
			void operator = (RenderableObject19 &&) = delete;
		};
