...
class Scene0;
class EnemyLayer;
class RenderableObject57 : public ::gc::TypeAliases<RenderableObject57>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject57 this_t;
	RenderableObject57 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject57(Scene0 &, EnemyLayer &);
	~RenderableObject57();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject57(const RenderableObject57 &) = delete;
			RenderableObject57(RenderableObject57 &&) = delete;
			void operator = (const RenderableObject57 &) = delete;
			void operator = (RenderableObject57 &&) = delete;
		};
