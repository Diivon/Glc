...
class Scene0;
class EnemyLayer;
class RenderableObject71 : public ::gc::TypeAliases<RenderableObject71>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject71 this_t;
	RenderableObject71 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject71(Scene0 &, EnemyLayer &);
	~RenderableObject71();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject71(const RenderableObject71 &) = delete;
			RenderableObject71(RenderableObject71 &&) = delete;
			void operator = (const RenderableObject71 &) = delete;
			void operator = (RenderableObject71 &&) = delete;
		};
