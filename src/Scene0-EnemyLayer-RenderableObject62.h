...
class Scene0;
class EnemyLayer;
class RenderableObject62 : public ::gc::TypeAliases<RenderableObject62>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject62 this_t;
	RenderableObject62 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject62(Scene0 &, EnemyLayer &);
	~RenderableObject62();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject62(const RenderableObject62 &) = delete;
			RenderableObject62(RenderableObject62 &&) = delete;
			void operator = (const RenderableObject62 &) = delete;
			void operator = (RenderableObject62 &&) = delete;
		};
