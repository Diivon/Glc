...
class Scene0;
class EnemyLayer;
class RenderableObject43 : public ::gc::TypeAliases<RenderableObject43>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject43 this_t;
	RenderableObject43 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject43(Scene0 &, EnemyLayer &);
	~RenderableObject43();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject43(const RenderableObject43 &) = delete;
			RenderableObject43(RenderableObject43 &&) = delete;
			void operator = (const RenderableObject43 &) = delete;
			void operator = (RenderableObject43 &&) = delete;
		};
