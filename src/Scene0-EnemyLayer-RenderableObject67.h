...
class Scene0;
class EnemyLayer;
class RenderableObject67 : public ::gc::TypeAliases<RenderableObject67>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject67 this_t;
	RenderableObject67 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject67(Scene0 &, EnemyLayer &);
	~RenderableObject67();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject67(const RenderableObject67 &) = delete;
			RenderableObject67(RenderableObject67 &&) = delete;
			void operator = (const RenderableObject67 &) = delete;
			void operator = (RenderableObject67 &&) = delete;
		};
