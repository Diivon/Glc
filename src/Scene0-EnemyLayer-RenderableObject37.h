...
class Scene0;
class EnemyLayer;
class RenderableObject37 : public ::gc::TypeAliases<RenderableObject37>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject37 this_t;
	RenderableObject37 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject37(Scene0 &, EnemyLayer &);
	~RenderableObject37();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject37(const RenderableObject37 &) = delete;
			RenderableObject37(RenderableObject37 &&) = delete;
			void operator = (const RenderableObject37 &) = delete;
			void operator = (RenderableObject37 &&) = delete;
		};
