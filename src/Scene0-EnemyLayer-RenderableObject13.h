...
class Scene0;
class EnemyLayer;
class RenderableObject13 : public ::gc::TypeAliases<RenderableObject13>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject13 this_t;
	RenderableObject13 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject13(Scene0 &, EnemyLayer &);
	~RenderableObject13();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject13(const RenderableObject13 &) = delete;
			RenderableObject13(RenderableObject13 &&) = delete;
			void operator = (const RenderableObject13 &) = delete;
			void operator = (RenderableObject13 &&) = delete;
		};
