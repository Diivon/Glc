...
class Scene0;
class EnemyLayer;
class RenderableObject33 : public ::gc::TypeAliases<RenderableObject33>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject33 this_t;
	RenderableObject33 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject33(Scene0 &, EnemyLayer &);
	~RenderableObject33();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject33(const RenderableObject33 &) = delete;
			RenderableObject33(RenderableObject33 &&) = delete;
			void operator = (const RenderableObject33 &) = delete;
			void operator = (RenderableObject33 &&) = delete;
		};
