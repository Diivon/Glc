...
class Scene0;
class EnemyLayer;
class RenderableObject34 : public ::gc::TypeAliases<RenderableObject34>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject34 this_t;
	RenderableObject34 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject34(Scene0 &, EnemyLayer &);
	~RenderableObject34();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject34(const RenderableObject34 &) = delete;
			RenderableObject34(RenderableObject34 &&) = delete;
			void operator = (const RenderableObject34 &) = delete;
			void operator = (RenderableObject34 &&) = delete;
		};
