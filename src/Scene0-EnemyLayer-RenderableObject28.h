...
class Scene0;
class EnemyLayer;
class RenderableObject28 : public ::gc::TypeAliases<RenderableObject28>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject28 this_t;
	RenderableObject28 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject28(Scene0 &, EnemyLayer &);
	~RenderableObject28();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject28(const RenderableObject28 &) = delete;
			RenderableObject28(RenderableObject28 &&) = delete;
			void operator = (const RenderableObject28 &) = delete;
			void operator = (RenderableObject28 &&) = delete;
		};
