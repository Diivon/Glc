...
class Scene0;
class EnemyLayer;
class RenderableObject26 : public ::gc::TypeAliases<RenderableObject26>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject26 this_t;
	RenderableObject26 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject26(Scene0 &, EnemyLayer &);
	~RenderableObject26();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject26(const RenderableObject26 &) = delete;
			RenderableObject26(RenderableObject26 &&) = delete;
			void operator = (const RenderableObject26 &) = delete;
			void operator = (RenderableObject26 &&) = delete;
		};
