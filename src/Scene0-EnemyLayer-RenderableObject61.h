...
class Scene0;
class EnemyLayer;
class RenderableObject61 : public ::gc::TypeAliases<RenderableObject61>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject61 this_t;
	RenderableObject61 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject61(Scene0 &, EnemyLayer &);
	~RenderableObject61();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject61(const RenderableObject61 &) = delete;
			RenderableObject61(RenderableObject61 &&) = delete;
			void operator = (const RenderableObject61 &) = delete;
			void operator = (RenderableObject61 &&) = delete;
		};
