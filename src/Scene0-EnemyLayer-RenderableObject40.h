...
class Scene0;
class EnemyLayer;
class RenderableObject40 : public ::gc::TypeAliases<RenderableObject40>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject40 this_t;
	RenderableObject40 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject40(Scene0 &, EnemyLayer &);
	~RenderableObject40();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject40(const RenderableObject40 &) = delete;
			RenderableObject40(RenderableObject40 &&) = delete;
			void operator = (const RenderableObject40 &) = delete;
			void operator = (RenderableObject40 &&) = delete;
		};
