...
class Scene0;
class EnemyLayer;
class RenderableObject17 : public ::gc::TypeAliases<RenderableObject17>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject17 this_t;
	RenderableObject17 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject17(Scene0 &, EnemyLayer &);
	~RenderableObject17();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject17(const RenderableObject17 &) = delete;
			RenderableObject17(RenderableObject17 &&) = delete;
			void operator = (const RenderableObject17 &) = delete;
			void operator = (RenderableObject17 &&) = delete;
		};
