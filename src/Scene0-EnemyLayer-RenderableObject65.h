...
class Scene0;
class EnemyLayer;
class RenderableObject65 : public ::gc::TypeAliases<RenderableObject65>{
	friend class ::gc::Camera;
	friend class EnemyLayer;
	typedef RenderableObject65 this_t;
	RenderableObject65 & self;
	Scene0 & scene;
	EnemyLayer & layer;
	public:
	...
	bool isVisible = true;
	bool isActive = true;
	RenderableObject65(Scene0 &, EnemyLayer &);
	~RenderableObject65();
	void onStart();
	...
	lref_t	 moveOn(const gc::Vec2 & v)noexcept {pos += v; return *this;}
		lref_t	 moveTo(const gc::Vec2 & v)noexcept {pos = v;  return *this;}
			private:
			RenderableObject65(const RenderableObject65 &) = delete;
			RenderableObject65(RenderableObject65 &&) = delete;
			void operator = (const RenderableObject65 &) = delete;
			void operator = (RenderableObject65 &&) = delete;
		};
